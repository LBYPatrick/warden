...
- `internal/tui`: Bubble Tea dashboard, Ashley light/dark palettes, saved accent settings, responsive sidebar navigation and details.
...
- `scripts/install.sh`: checksum-verified, version-pinned release installer with automatic legacy launcher migration.
